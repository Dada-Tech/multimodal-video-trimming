...
if not skip_text_metrics:
  ...
  # tokenizer
  tokenizer_lf = LongformerTokenizer.from_pretrained(model_name_lf, model_max_length=model_max_length)
  tokenizer_lf.model_max_length = model_max_length

if not skip_text_metrics:
  # 2: Tokenization
  paragraph_tokens = tokenizer_lf(paragraph_summarized, return_tensors='pt', truncation=True, max_length=model_max_length)
